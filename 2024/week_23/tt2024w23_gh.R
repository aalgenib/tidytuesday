...
my_dir <- "~/R/tidytuesdays/2024/2024w23"
...
us_states_codes <- read_csv("~/R/tidytuesdays/2024/2024w23/states.csv") |> 
...
plt1 <- ggplot() +
  ...
  theme(
    ...
    plot.title = element_markdown(hjust = 0.5, family = ft1, size = 63, color = col_ft1, margin = margin(c(1, 0, 0, 0), unit = "cm")),
